...
function uuid(): string {
  // crypto.randomUUID keeps the fixtures using proper v4 UUIDs and avoids the
  // insecure-randomness pattern CodeQL flags when a Math.random() value flows
  // into a selector built from the session id.
