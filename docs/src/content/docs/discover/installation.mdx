...
3. The pack analysis is fully local: your open tabs are read in the browser only, nothing leaves your machine. You can dismiss the suggestions to keep the generic actions.
