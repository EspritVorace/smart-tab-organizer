...
2. Pick the source: a JSON file (drag and drop or browse), pasted text, or the packs gallery (see [Categories and packs](/reference/categories-et-packs)).
...
<CardGrid>
  <LinkCard title="Domain Rules" href="/guides/regles-de-domaine" description="The CRUD and the multi-selection." />
  ...
  <LinkCard title="Categories and packs" href="/reference/categories-et-packs" description="The other import path: the gallery of built-in packs." />
</CardGrid>
