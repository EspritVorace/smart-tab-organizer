...
The **Deduplication** toggle in the popup or in the [Settings](/guides/parametres) page is the master switch. When off, no deduplication happens, no matter the rules. An orange **D** badge appears on the extension icon in that case.
...
On the [Settings](/guides/parametres) page, in the **Deduplication scope** section, you choose which of the two duplicate tabs survives:
...
<CardGrid>
  <LinkCard title="Group tabs" href="/guides/grouper-onglets" description="The parallel mechanism that organizes tabs into groups." />
  <LinkCard title="Domain Rules" href="/guides/regles-de-domaine" description="Pick the deduplication mode and ignored parameters per rule." />
  <LinkCard title="Settings" href="/guides/parametres" description="Global toggles, keep strategy, notifications." />
</CardGrid>
