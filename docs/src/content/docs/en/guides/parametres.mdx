...
<Aside type="note">
The **global toggles** for grouping and deduplication are not here: they live in the [popup](/guides/popup) (and in the icon badge, see [Interface tour](/decouverte/tour-interface#indicateur-sur-licone)).
</Aside>
...
See [Deduplicate](/guides/dedupliquer#strategies-de-conservation) for the full context.
...
The four targets remain reachable via the [keyboard shortcuts](/reference/raccourcis-clavier) (`R`, `Shift+R`, `Alt+R`, `Alt+Shift+R`) on a focused session or profile, no matter the value of this setting.

## Next steps

<CardGrid>
  <LinkCard title="Popup" href="/guides/popup" description="Global grouping and deduplication toggles." />
  <LinkCard title="Deduplicate" href="/guides/dedupliquer" description="The three match modes, context for the keep strategy." />
  <LinkCard title="Sessions" href="/guides/sessions" description="The default Restore action in context." />
  <LinkCard title="Interface tour" href="/decouverte/tour-interface" description="The icon badge that reflects the state of the global toggles." />
</CardGrid>
