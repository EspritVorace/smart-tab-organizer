...
| **Pack** | Adds **several rules** at once. See [Categories and packs](/reference/categories-et-packs). |
...
<CardGrid>
  <LinkCard title="Domain Rules" href="/guides/regles-de-domaine" description="The creation wizard and the Preset field." />
  <LinkCard title="Categories and packs" href="/reference/categories-et-packs" description="The other path: import several rules at once." />
  <LinkCard title="Group tabs" href="/guides/grouper-onglets" description="How a preset drives the naming mode and the regexes." />
</CardGrid>
