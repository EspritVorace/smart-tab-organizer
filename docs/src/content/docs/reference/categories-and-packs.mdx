...
You can reimport a pack several times with different parameters: rules already present are detected as conflicts by the import wizard and resolved case by case (see [Import / Export](/guides/import-export#conflict-resolution)).
