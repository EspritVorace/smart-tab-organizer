...
A click or pressing `Enter` uses the **default action** configured in [Settings](/guides/settings#action-de-restauration-par-defaut).
...
<Aside type="note">
Tabs restored through the wizard are protected against immediate deduplication for 10 seconds (same mechanism as [Undo on deduplication](/guides/deduplicate#notification-et-annulation)).
</Aside>
