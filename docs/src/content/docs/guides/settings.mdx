...
<Aside type="note">
The **global toggles** for grouping and deduplication are not here: they live in the [popup](/guides/popup) (and in the icon badge, see [Interface tour](/discover/interface-tour#badge)).
</Aside>
...
See [Deduplicate](/guides/deduplicate#keep-strategy) for the full context.

## Default action (Restore) \{#default-restore}
