...
export const CalloutsFeatureCallouts: StoryObj = {
  ...
  render: () => (
    <Flex direction="column" gap="4" p="4">
      ...
      <Box>
        <Text as="h3" size="4" weight="bold" mb="3">Logical Groups Callouts (Blue)</Text>
        <Flex direction="column" gap="2">
          <LogicalGroupsCallouts.Info>
            Logical group created successfully. You can now assign domain rules to this group.
          </LogicalGroupsCallouts.Info>
          <LogicalGroupsCallouts.Warning>
            This group has no associated domain rules. Consider adding some rules to make it functional.
          </LogicalGroupsCallouts.Warning>
          <LogicalGroupsCallouts.Error>
            Group name already exists. Please choose a different name for your logical group.
          </LogicalGroupsCallouts.Error>
        </Flex>
      </Box>
  ...
  render: () => (
    <Flex direction="column" gap="4" p="4">
      ...
      <Flex direction="column" gap="3">
        ...
        <Flex align="center" gap="3">
          <Text size="2" weight="medium" style={{ minWidth: '120px' }}>Logical Groups:</Text>
          <LogicalGroupsCallouts.Info>Blue themed callout for logical group operations</LogicalGroupsCallouts.Info>
        </Flex>
...
export const CalloutsNuancedColors: StoryObj = {
  ...
  render: () => (
    <Flex direction="column" gap="4" p="4">
      ...
      <Box>
        <Text as="h3" size="4" weight="bold" mb="3">Logical Groups (Blue Family)</Text>
        <Flex direction="column" gap="2">
          <LogicalGroupsCallouts.Info>Blue for informational messages</LogicalGroupsCallouts.Info>
          <LogicalGroupsCallouts.Warning>Indigo for warnings</LogicalGroupsCallouts.Warning>
          <LogicalGroupsCallouts.Error>Navy for errors</LogicalGroupsCallouts.Error>
        </Flex>
      </Box>
  ...
  render: () => (
    <Flex direction="column" gap="4" p="4">
      ...
      <Box>
        ...
        <Flex direction="column" gap="2">
          <LogicalGroupsCallouts.Info style={{ marginTop: '16px' }}>
            No logical groups are defined yet. Create your first group to start organizing your domain rules.
          </LogicalGroupsCallouts.Info>
