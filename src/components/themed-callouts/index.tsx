...
export const LogicalGroupsCallouts = {
  Info: (props: ThemedCalloutProps) => <InfoCallout theme={FEATURE_CALLOUT_COLORS.LOGICAL_GROUPS.INFO} {...props} />,
  Warning: (props: ThemedCalloutProps) => <WarningCallout theme={FEATURE_CALLOUT_COLORS.LOGICAL_GROUPS.WARNING} {...props} />,
  Error: (props: ThemedCalloutProps) => <ErrorCallout theme={FEATURE_CALLOUT_COLORS.LOGICAL_GROUPS.ERROR} {...props} />
};
