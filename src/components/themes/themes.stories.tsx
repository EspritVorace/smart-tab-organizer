...
const meta: Meta = {
  title: 'Themes/Themed Components',
  parameters: {
    layout: 'padded',
  },
  tags: ['autodocs'],
...
export const ThemesAllThemes: StoryObj = {
  ...
  render: () => (
    <Flex direction="column" gap="2">
      ...
      <ThemeShowcase ThemeComponent={LogicalGroupsTheme} title="Logical Groups Theme (Iris)" />
...
export const ThemesLogicalGroups: StoryObj = {
  name: 'Logical Groups Theme',
  render: () => (
    <LogicalGroupsTheme>
      <Flex direction="column" gap="4" p="4">
        <Text as="h2" size="6" weight="bold">Logical Groups Management</Text>
        <Flex direction="column" gap="3">
          <Flex gap="2" align="center">
            <Text size="2" weight="medium" style={{ minWidth: '120px' }}>Group Name:</Text>
            <TextField.Root placeholder="Work Projects" style={{ width: '250px' }} />
          </Flex>
          <Flex gap="2" align="center">
            <Text size="2" weight="medium" style={{ minWidth: '120px' }}>Color:</Text>
            <Select.Root defaultValue="blue">
              <Select.Trigger placeholder="Select color..." style={{ width: '150px' }} />
              <Select.Content>
          ...
          <Flex gap="2" align="center">
            ...
            <Button variant="soft">Edit Group</Button>
