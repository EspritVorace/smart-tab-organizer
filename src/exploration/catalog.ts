...
export const CATALOG: readonly CatalogEntry[] = [
  ...
  e('grouping.create', 'grouping', '#rules?action=new', 'touchpoint', { doc: 'guides/domain-rules' }),
  e('grouping.edit', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules', prerequisites: HAS_RULE }),
  e('grouping.mode.preset', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules' }),
  e('grouping.mode.ask', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules' }),
  e('grouping.mode.manual', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules' }),
  e('grouping.mode.label', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules' }),
  ...
  e('grouping.url.regex', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules' }),
  e('grouping.url.queryParam', 'grouping', '#rules', 'touchpoint', { doc: 'guides/domain-rules' }),
  ...
  // 2. Déduplication
  e('dedup.match.exact', 'dedup', '#rules', 'derivation', { doc: 'guides/deduplicate' }),
  e('dedup.match.includes', 'dedup', '#rules', 'derivation', { doc: 'guides/deduplicate' }),
  e('dedup.match.ignoreParams', 'dedup', '#rules', 'derivation', { doc: 'guides/deduplicate' }),
  e('dedup.togglePerRule', 'dedup', '#rules', 'touchpoint', { prerequisites: HAS_RULE }),
  e('dedup.keep.old', 'dedup', '#settings', 'touchpoint', { doc: 'guides/deduplicate', prerequisites: DEDUP_ENABLED }),
  e('dedup.keep.new', 'dedup', '#settings', 'touchpoint', { doc: 'guides/deduplicate', prerequisites: DEDUP_ENABLED }),
  e('dedup.keep.grouped', 'dedup', '#settings', 'touchpoint', { doc: 'guides/deduplicate', prerequisites: DEDUP_ENABLED }),
  e('dedup.keep.groupedOrNew', 'dedup', '#settings', 'touchpoint', { doc: 'guides/deduplicate', prerequisites: DEDUP_ENABLED }),
  e('dedup.uncoveredScope', 'dedup', '#settings', 'touchpoint', { prerequisites: DEDUP_ENABLED }),
  e('dedup.organize', 'dedup', '#home', 'counter', { doc: 'guides/deduplicate' }),
  ...
  // 5. Packs
  e('packs.openGallery', 'packs', '#home', 'ephemeral', { doc: 'reference/categories-and-packs' }),
  ...
  e('packs.apply', 'packs', '#home', 'touchpoint', { doc: 'reference/categories-and-packs', prerequisites: 'packs.openGallery' }),
  ...
  e('settings.toggle.grouping', 'settings', '#settings', 'touchpoint', { doc: 'guides/domain-rules' }),
  e('settings.toggle.dedup', 'settings', '#settings', 'touchpoint', { doc: 'guides/deduplicate' }),
