...
export function domainToRegex(domainFilter) {
    ...
    catch (e) { logger.error("Err domainToRegex:", domainFilter, e); return null; }
}
...
export function extractGroupNameFromTitle(title, regexString) {
    ...
    catch (e) { logger.error("Err extractGroupName:", title, regexString, e); return null; }
}
export function extractGroupNameFromUrl(url, regexString) {
    ...
    catch (e) { logger.error("Err extractGroupNameFromUrl:", url, regexString, e); return null; }
}
